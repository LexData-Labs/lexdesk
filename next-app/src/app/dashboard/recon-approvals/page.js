...
export default function ReconApprovalsPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader title="Reconciliation Approvals" subtitle="Approving applies the corrected in/out to that day's attendance" actions={<button onClick={load} className="btn-outline py-2 px-4 text-sm">Refresh</button>} />
